-- DEPRECATED: Postgres schema moved to postgres_deprecated for archival purposes
-- Original schema preserved here. Not used by CSV-only mode.

-- Vidyut Aadhaar Intelligence Platform Schema
