    ...
    try {
      ...
      const mockAnomalies: Anomaly[] = [
        ...
        },
        {
          ...
          state: "Uttar Pradesh",
          district: "Lucknow",
          description: "156 enrollments registered from same address within 24-hour period",
          recordsAffected: 156,
        ...
        },
        {
          ...
          severity: "medium",
          state: "Karnataka",
          description: "89 records show age inconsistency with previous enrollment data",
          recordsAffected: 89,
        ...
        },
        {
          ...
          state: "Bihar",
          district: "Patna",
          description: "Enrollment rate increased by 340% compared to 30-day average",
        ...
        },
        {
          ...
          severity: "low",
          state: "Tamil Nadu",
          description: "42 records flagged for poor fingerprint quality requiring re-capture",
          recordsAffected: 42,
...
Provide a detailed, actionable analysis.`
      ...
      const mockAnalysis = generateAIAnalysis(anomaly)
      setAnomalies(prev => prev.map(a => 
        a.id === anomaly.id ? { ...a, aiAnalysis: mockAnalysis } : a
      ))
    } finally {
      setAnalyzing(false)
    }
  ...
  const generateAIAnalysis = (anomaly: Anomaly): string => {
    ...
    return analyses[anomaly.type] || "AI analysis pending..."
  }

  const getSeverityConfig = (severity: string) => {
    const configs = {
      critical: { color: "bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300", icon: "🚨", badge: "destructive" },
      high: { color: "bg-orange-100 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300", icon: "⚠️", badge: "default" },
      medium: { color: "bg-yellow-100 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-300", icon: "⚡", badge: "secondary" },
      low: { color: "bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-300", icon: "ℹ️", badge: "outline" }
    }
